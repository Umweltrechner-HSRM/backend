...
/**
 * Class {@code SymbolTable} provides the functionality of a symbol table containing key-value
 * pairs. The value associated with each key is a {@link SymbolEntry} object. Intended to be managed
 * by a corresponding Interpreter.
 */
public class SymbolTable {

  /**
   * Class {@code SymbolEntry} specifies the values of a symbol entry in the {@link SymbolTable}
   * class.
   */
  @Data
